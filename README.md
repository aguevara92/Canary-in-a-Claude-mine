...
1. Every session starts with one injected instruction: begin the final message of every turn with `🐤` and a period (a canary, what else). It can be any word or a single emoji. Nothing to add to your `CLAUDE.md`.
